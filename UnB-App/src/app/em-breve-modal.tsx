  ...
  return (
    <SafeAreaView style={[styles.safeArea, { backgroundColor: colors.background }]} edges={Platform.OS === 'ios' ? ['top', 'bottom'] : ['bottom']}>
      ...
      <View style={styles.content}>
        <SymbolView name={{ ios: "sparkles", android: "auto_awesome", web: "auto_awesome" } as any} size={48} tintColor={colors.primary} fallback={<Text style={{ fontSize: 40 }}>✨</Text>} />
        <Text style={[styles.message, { fontSize: getFontSize(24), color: colors.textPrimary }]}>Em breve! :)</Text>
      </View>
    </SafeAreaView>
  );
}
