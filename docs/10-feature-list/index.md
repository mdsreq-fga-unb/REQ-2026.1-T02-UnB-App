...
<article class="card" style="border: 1px solid #e2e8f0; border-radius: 8px; padding: 1.5rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
  ...
  <h3>Evidências de Teste</h3>
  <p>Testes automatizados (Jest) das duas features entregues nesta iteração — documentos (upload, validação e tela) e grade horária (parser, consultas SQLite e tela offline). <strong>27 testes em 5 suítes, 100% passando.</strong></p>
  <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
    <a href="../assets/evidencias/testes-f09-documentos.png" target="_blank" rel="noopener">
      <img src="../assets/evidencias/testes-f09-documentos.png" alt="Testes automatizados F09 - Documentos: 16/16 passando" style="max-height: 260px; border-radius: 8px;" />
    </a>
    <a href="../assets/evidencias/testes-f07-grade.png" target="_blank" rel="noopener">
      <img src="../assets/evidencias/testes-f07-grade.png" alt="Testes automatizados F07 - Grade Horária: 11/11 passando" style="max-height: 260px; border-radius: 8px;" />
    </a>
  </div>
  <p><em>Detalhe por feature: <a href="../10-feature-list/feature-list-geral.md#f09">F09 — Evidência de Testes</a> · <a href="../10-feature-list/feature-list-geral.md#f07">F07 — Evidência de Testes</a>.</em></p>
</article>
...
<article class="card" style="border: 1px solid #e2e8f0; border-radius: 8px; padding: 1.5rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
  ...
  <p>
    ...
    <strong>Data Final:</strong> 30/06/2026<br>
    <strong>Responsáveis:</strong>
  </p>
  <ul>
  ...
  <h3>Protótipos / Evidências</h3>
  <p><em>Esta iteração envolve features predominantemente de backend (scraping do SIGAA e processamento de PDF). A evidência primária de conclusão e funcionamento encontra-se nas suítes de testes abaixo.</em></p>

  <h3>Evidências de Teste</h3>
  <p>Sem tela para mostrar ainda, mas a lógica por trás das duas features já está coberta por testes automatizados (Jest) rodando contra dados simulados (fixtures) — o parser do Histórico Escolar e a sincronização com o SIGAA/calendário acadêmico. <strong>12 testes em 3 suítes, 100% passando.</strong></p>
  <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
    <a href="../assets/evidencias/testes-f04-historico.png" target="_blank" rel="noopener">
      <img src="../assets/evidencias/testes-f04-historico.png" alt="Testes automatizados F04 - Histórico Escolar: 6/6 passando" style="max-height: 260px; border-radius: 8px;" />
    </a>
    <a href="../assets/evidencias/testes-f08-sigaa-calendario.png" target="_blank" rel="noopener">
      <img src="../assets/evidencias/testes-f08-sigaa-calendario.png" alt="Testes automatizados F08 - SIGAA e Calendário: 6/6 passando" style="max-height: 260px; border-radius: 8px;" />
    </a>
  </div>
  <p><em>Detalhe por feature: <a href="../10-feature-list/feature-list-geral.md#f04">F04 — Evidência de Testes</a> · <a href="../10-feature-list/feature-list-geral.md#f08">F08 — Evidência de Testes</a>.</em></p>
</article>
...
<article class="card" style="border: 1px solid #e2e8f0; border-radius: 8px; padding: 1.5rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
  ...
  <h3>Evidências de Teste</h3>
  <p>Onboarding (F05) já está coberto por testes automatizados (Jest) — a tela de Boas-Vindas, incluindo o fluxo de pular e o salvamento ao concluir. <strong>3 testes em 1 suíte, 100% passando.</strong></p>
  <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
    <a href="../assets/evidencias/testes-f05-onboarding.png" target="_blank" rel="noopener">
      <img src="../assets/evidencias/testes-f05-onboarding.png" alt="Testes automatizados F05 - Onboarding: 3/3 passando" style="max-height: 260px; border-radius: 8px;" />
    </a>
  </div>
  <p><em>Detalhe: <a href="../10-feature-list/feature-list-geral.md#f05">F05 — Evidência de Testes</a>. Carteirinha (F03) e QRCode (F02) ainda não têm testes automatizados — implementação segue em fase de mockup/branch.</em></p>
</article>
