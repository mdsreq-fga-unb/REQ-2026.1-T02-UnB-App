...
Ademais, o acesso à representante dos usuários (Maria Fátima) via canais diretos de comunicação como WhatsApp e Teams garante ciclos rápidos de validação, permitindo a entrega de um **MVP funcional** que inclua a consulta de grade horária e carteirinha digital até o final das sprints planejadas.
...
!!! warning "Riscos identificados"
    ...
    - **Fadiga ou falta de disponibilidade dos usuários 60+ para testes** — mitigação: Planejar reuniões quinzenais curtas via Microsoft Teams ou google-meet e coletar feedbacks por meio do WhatsApp.
