...
<article class="card" style="border: 1px solid #e2e8f0; border-radius: 8px; padding: 1.5rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
  <h2 style="margin-top: 0;"><a id="i3"></a> 🟡 Iteração 3: Onboarding (F05)</h2>
...
<article class="card" style="border: 1px solid #e2e8f0; border-radius: 8px; padding: 1.5rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
  <h2 style="margin-top: 0;"><a id="i4"></a> 🟡 Iteração 4: Carteirinha e QRCode (F02, F03)</h2>
  ...
  <h3>Protótipos / Evidências</h3>
  <p><em>Branches em andamento. Protótipos em fase final de validação visual.</em></p>
</article>
