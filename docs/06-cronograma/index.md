...
<article class="card" style="border: 1px solid #e2e8f0; border-radius: 8px; padding: 1.5rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
  ...
  <h3>Protótipos / Evidências</h3>
  <iframe width="315" height="560" src="https://www.youtube.com/embed/kpoSs_bZaiM" title="Vídeo de Demonstração (Iteração 2)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);"></iframe>
</article>
