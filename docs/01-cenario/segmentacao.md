...
=== "Usuários letrados em tecnologia"
    ...
    - **Comportamento:** conseguem navegar pelo SIGAA com menos dificuldades, mas relatam incômodo com excesso de informações, nomenclaturas pouco intuitivas, fluxos confusos e baixa legibilidade.
    - **Necessidades principais:** fluxos mais objetivos, melhor organização da informação e melhoria de leitura na interface.
...
=== "Usuários intermediários (adaptáveis)"
    ...
    - **Comportamento:** realizam tarefas básicas, porém enfrentam dificuldades em fluxos pouco intuitivos ou situações que exigem maior interpretação da interface.
    - **Necessidades principais:** experiência mais intuitiva, redução de tentativa e erro e menor dependência de suporte externo.
...
=== "Usuários com pouca familiaridade tecnológica"
    ...
    - **Comportamento:** dificuldade para tarefas simples como login, localização de funcionalidades e interpretação de informações na tela.
    - **Necessidades principais:** simplificação extrema de fluxos, apoio guiado e autonomia para tarefas básicas sem auxílio constante.
...
=== "Usuários com barreiras de acessibilidade"
    ...
    - **Comportamento:** sofrem impacto direto com letras pequenas, baixo contraste, excesso de informação e fluxos pouco claros.
    - **Necessidades principais:** adequação da interface às limitações visuais e motoras, com leitura facilitada e navegação clara.
