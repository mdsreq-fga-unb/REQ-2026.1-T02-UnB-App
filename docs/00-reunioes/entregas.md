...
- Contextualização do problema de usabilidade e acessibilidade do SIGAA para o público 60+.
- Apresentação do objetivo geral e dos objetivos específicos do produto.
- Definição das características centrais do aplicativo:
	- identidade e acesso institucional;
	- visualização da rotina acadêmica;
