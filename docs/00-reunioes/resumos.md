...
|---------|------|---------------------|------------|-----------------|
| R01 | 13/04/2026 | Produto focado em autonomia acadêmica para discentes 60+; adoção de Scrum quinzenal; validação contínua com cliente; definição dos diferenciais de acessibilidade e suporte offline. | Confirmar estratégia técnica de integração com dados institucionais; detalhar RF/RNF e critérios de aceitação da U2; organizar agenda de validações com a cliente. | Iniciar U2 com elicitação e refinamento de requisitos; montar backlog priorizado (MoSCoW); preparar critérios de validação e plano de testes de usabilidade com público 60+. |
...
- O processo de trabalho seguirá Scrum com sprints de 15 dias.
- As interações com stakeholders ocorrerão em dois ritmos:
	- validações quinzenais nas revisões de sprint;
